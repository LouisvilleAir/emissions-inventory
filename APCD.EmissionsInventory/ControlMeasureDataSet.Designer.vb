...
Namespace ControlMeasureDataSetTableAdapters
    ...
    Partial Public Class ControlMeasureTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT        ControlMeasureID, ControlMeasureDescription, PlantID, ControlMeasur"& _ 
                "eTypeID, ControlMeasureAPCDID, BeginDate, EndDate, CompanyComment, APCDComment, "& _ 
                ""&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         AddDate, AddedBy"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            ControlMeasure"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHE"& _ 
                "RE        (ControlMeasureID = ?)"
        ...
        Public Overloads Overridable Function FillByControlMeasureID(ByVal dataTable As ControlMeasureDataSet.ControlMeasureDataTable, ByVal ControlMeasureID As Integer) As Integer
        ...
        Public Overloads Overridable Function GetDataByControlMeasureID(ByVal ControlMeasureID As Integer) As ControlMeasureDataSet.ControlMeasureDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(ControlMeasureID,Integer)
            Dim dataTable As ControlMeasureDataSet.ControlMeasureDataTable = New ControlMeasureDataSet.ControlMeasureDataTable()
